...
public class Config
{
    ...
    static void onLoad(final FMLCommonSetupEvent event)
    {
        ...
        List<Block> saplings=List.of(samebutdifferent.ecologics.registry.ModBlocks.COCONUT_SEEDLING.get(), UGBlocks.GRONGLE_SAPLING.get(), Blocks.SPRUCE_SAPLING,Blocks.ACACIA_SAPLING,Blocks.CHERRY_SAPLING,Blocks.BIRCH_SAPLING,Blocks.DARK_OAK_SAPLING,Blocks.JUNGLE_SAPLING,Blocks.OAK_SAPLING,Blocks.MANGROVE_PROPAGULE);
